...
const getSliceId=(sliceName,sliceProps)=>{if(!Object.keys(sliceProps).length){return sliceName;}const propsString=createContentDigest(sliceProps);return`${sliceName}-${propsString}`;};const ServerSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_C_Projects_Websites_CASE_STUDY_FORM_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesProps=(0,external_C_Projects_Websites_CASE_STUDY_FORM_node_modules_react_index_js_.useContext)(context.SlicesPropsContext);const concreteSliceName=slicesMap[sliceName];if(!concreteSliceName){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}const sliceId=getSliceId(concreteSliceName,sliceProps);// set props on context object for static-entry to return
let sliceUsage=slicesProps[sliceId];if(!sliceUsage){slicesProps[sliceId]=sliceUsage={props:sliceProps,sliceName:concreteSliceName,hasChildren:!!children};}else{if(children){sliceUsage.hasChildren=true;}}return/*#__PURE__*/external_C_Projects_Websites_CASE_STUDY_FORM_node_modules_react_index_js_default().createElement(server_slice_renderer.ServerSliceRenderer,{sliceId:sliceId},children);};
;// ./.cache/slice/inline-slice.js
const InlineSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_C_Projects_Websites_CASE_STUDY_FORM_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesResultsMap=(0,external_C_Projects_Websites_CASE_STUDY_FORM_node_modules_react_index_js_.useContext)(context.SlicesResultsContext);const concreteSliceName=slicesMap[sliceName];const slice=slicesResultsMap.get(concreteSliceName);if(!slice){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}return/*#__PURE__*/external_C_Projects_Websites_CASE_STUDY_FORM_node_modules_react_index_js_default().createElement(slice.component,Object.assign({sliceContext:slice.sliceContext,data:slice.data},sliceProps),children);};
;// ./.cache/slice.js
"use client";function Slice(props){if(true){// we use sliceName internally, so remap alias to sliceName
const internalProps={...props,sliceName:props.alias};delete internalProps.alias;delete internalProps.__renderedByLocation;const slicesContext=(0,external_C_Projects_Websites_CASE_STUDY_FORM_node_modules_react_index_js_.useContext)(context.SlicesContext);// validate props
const propErrors=validateSliceProps(props);if(Object.keys(propErrors).length){throw new SlicePropsError(slicesContext.renderEnvironment===`browser`,internalProps.sliceName,propErrors,props.__renderedByLocation);}if(slicesContext.renderEnvironment===`server`){return/*#__PURE__*/external_C_Projects_Websites_CASE_STUDY_FORM_node_modules_react_index_js_default().createElement(ServerSlice,internalProps);}else if(slicesContext.renderEnvironment===`browser`){// in the browser, we'll just render the component as is
return/*#__PURE__*/external_C_Projects_Websites_CASE_STUDY_FORM_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`engines`||slicesContext.renderEnvironment===`dev-ssr`){// if we're in SSR, we'll just render the component as is
return/*#__PURE__*/external_C_Projects_Websites_CASE_STUDY_FORM_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`slices`){// we are not yet supporting nested slices
...
if((external_C_Projects_Websites_CASE_STUDY_FORM_node_modules_react_index_js_default()).captureOwnerStack){// React 19+ approach
const ownerStack=external_C_Projects_Websites_CASE_STUDY_FORM_node_modules_react_index_js_default().captureOwnerStack();const currentStack=new Error().stack||``;fullStack=ownerStack?`${currentStack}\n${ownerStack}`:currentStack;}else if((_React$__SECRET_INTER=(external_C_Projects_Websites_CASE_STUDY_FORM_node_modules_react_index_js_default()).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED)!==null&&_React$__SECRET_INTER!==void 0&&(_React$__SECRET_INTER2=_React$__SECRET_INTER.ReactDebugCurrentFrame)!==null&&_React$__SECRET_INTER2!==void 0&&_React$__SECRET_INTER2.getCurrentStack){// React 18 approach
fullStack=external_C_Projects_Websites_CASE_STUDY_FORM_node_modules_react_index_js_default().__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactDebugCurrentFrame.getCurrentStack();}else{// Fallback if neither API is available
...
var _react = _interopRequireDefault(__webpack_require__(3774));
...
"use strict";
module.exports = require("C:\\Projects\\Websites\\CASE_STUDY_FORM\\.cache\\ssr-builtin-trackers\\fs");
...
"use strict";
module.exports = require("C:\\Projects\\Websites\\CASE_STUDY_FORM\\.cache\\ssr-builtin-trackers\\http");
...
var React = __webpack_require__(3774);
...
var React = _interopRequireWildcard(__webpack_require__(3774));
...
var _react = __webpack_require__(3774);
...
"use strict";
module.exports = require("C:\\Projects\\Websites\\CASE_STUDY_FORM\\node_modules\\react\\index.js");
...
"use strict";
module.exports = require("C:\\Projects\\Websites\\CASE_STUDY_FORM\\.cache\\ssr-builtin-trackers\\https");
...
exports.components={"component---src-pages-admin-jsx":()=>Promise.all(/* import() | component---src-pages-admin-jsx */[__webpack_require__.e(492), __webpack_require__.e(758)]).then(__webpack_require__.bind(__webpack_require__, 9536)),"component---src-pages-form-[slug]-jsx":()=>Promise.all(/* import() | component---src-pages-form-[slug]-jsx */[__webpack_require__.e(492), __webpack_require__.e(807)]).then(__webpack_require__.bind(__webpack_require__, 909)),"component---src-pages-index-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-index-jsx */ 279).then(__webpack_require__.bind(__webpack_require__, 7325))};
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3774);
...
const isHeadRenderFromContext=external_C_Projects_Websites_CASE_STUDY_FORM_node_modules_react_index_js_default().useContext(IsHeadRenderContext);return isHeadRenderFromContext;}function htmlOrBodyComponentFactory(TagName){const HeadAwareComponent=props=>{// De-risk monkey patch by only applying it within a `Head()` render.
...
const React=__webpack_require__(3774);const{grabMatchParams}=__webpack_require__(5870);const{StaticQueryContext}=__webpack_require__(123);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(3304);const{ServerLocation,Router}=__webpack_require__(6462);const{renderToString}=__webpack_require__(8322);const{parse}=__webpack_require__(6192);const styleToOjbect=__webpack_require__(9108);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(6560),options:{"plugins":[]}},{name:'partytown',plugin:__webpack_require__(387),options:{"plugins":[]}}];/* global plugins */// During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
/******/ 			return "" + ({"279":"component---src-pages-index-jsx","758":"component---src-pages-admin-jsx","807":"component---src-pages-form-[slug]-jsx"}[chunkId] || chunkId) + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
